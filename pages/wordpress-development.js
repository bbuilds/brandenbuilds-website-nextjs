        ...
        <section className="pt-10 pb-20 post-content">
          <div className="px-4 max-w-3xl mx-auto">
            <p>
              ...
              It&pos;s a highly flexible and customizable CMS that I have
              tinkered with every aspect of the WordPress ecosystem.
            </p>
            <h2>An Actual WordPress Developer</h2>
            <p>
              WordPress can get a bad reputation from being bloated and having a
              lot of people &quot;claim&quot; to be developers and then build a
              half-assed website using a site builder. It can be really
              difficult to sift through the thousands of marketing or &quot;web
              development&quot; agencies to see who is legit.
            </p>
            <p>
              When I builds WordPress solutions or join a team, I am looking to
              build from the ground up and use as minimal plugins as possible. I
              take pride in the speed and code quality of every WordPress
              website project I&#x27;m in.
            </p>
