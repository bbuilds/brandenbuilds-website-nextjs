...
export default function Services({ servicesList, skillsList }) {
	return (
		<>
			<section id="services" className="py-10 lg:py-20 bg-bbuilds-yellow text-bbuilds-black">
							...
							{servicesList.map((service, index) => (
								...
								>
									<Link href={service.url}>
										<a className="p-4 border border-bbuilds-black rounded w-full h-full transition duration-300 ease-in-out transform hover:-translate-y-2 hover:bg-bbuilds-black hover:text-bbuilds-yellow">
